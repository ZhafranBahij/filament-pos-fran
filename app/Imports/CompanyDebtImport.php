...
class CompanyDebtImport implements ToModel, WithChunkReading, WithBatchInserts, WithHeadingRow
{
    public function model(array $row)
    {

        $category = CompanyDebtCategory::firstOrCreate(
            ['name' => $row['company_debt_category']],
        );
        ...
        CompanyDebt::create([
            'name' => $row['name'],
            'status' => $row['status'],
            'company_debt_category_id' => $category->id,
            'debtor_id' => $debtor->id,
